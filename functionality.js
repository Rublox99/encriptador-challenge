...
var botonCopiarEntrada= document.getElementById("copiarEntrada");
var botonCopiarSalida= document.getElementById("copiarSalida");
...
botonCopiarEntrada.onclick= copiarEntrada;
botonCopiarSalida.onclick= copiarSalida;
...
function copiarEntrada(){
    let copiar= document.getElementById("texto-ingresado");
    copiar.select();
    document.execCommand("copy");
}

function copiarSalida(){
    let copiar= document.getElementById("texto-resultado");
    copiar.select();
    document.execCommand("copy");
}
